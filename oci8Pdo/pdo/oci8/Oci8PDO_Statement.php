...
//     	} else
     ...
     * @return string
     */
    public function fetchColumn($colNumber = 0): mixed
    {
    	$result = oci_fetch_array($this->_sth, OCI_NUM);
     ...
     * @return mixed
     */
    public function fetchObject($className = 'stdClass', $ctor_args = null): object|false
    {
